...
modelo_glmP1 <- glm(P ~ H1, data = Tarea4, family = poisson)
summary(modelo_glmP1)

modelo_glmP2 <- glm(P ~ H2, data = Tarea4, family = poisson)
summary(modelo_glmP2)

modelo_glmP3 <- glm(P ~ H3, data = Tarea4, family = poisson)
summary(modelo_glmP3)

modelo_glmP4 <- glm(P ~ H4, data = Tarea4, family = poisson)
summary(modelo_glmP4)

modelo_glmP5 <- glm(P ~ H5, data = Tarea4, family = poisson)
...
modelo_glmA1 <- glm(A ~ H1, data = Tarea4, family = poisson)
summary(modelo_glmA1)

modelo_glmA2 <- glm(A ~ H2, data = Tarea4, family = poisson)
summary(modelo_glmA2)

modelo_glmA3 <- glm(A ~ H3, data = Tarea4, family = poisson)
summary(modelo_glmA3)

modelo_glmA4 <- glm(A ~ H4, data = Tarea4, family = poisson)
summary(modelo_glmA4)

modelo_glmA5 <- glm(A ~ H5, data = Tarea4, family = poisson)
...
Agregamos modelos de regresion lineal de Poisson usando P y A como variables respuesta frente a variables predictoras ambientales (h1, h2, h3, h4, h5). De este análisis se obtine para un 95% de confianza que todos los factores ambientales afectan la distribución de P y que para A solamente lo hacen h2, h3 y h4.
