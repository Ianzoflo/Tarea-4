...
Como son conteos y distribucion tiende a ser Poisson se realiza regresion lineal de Poisson para todas las variables

```{r}
# Como son conteos y distribucion tiende a ser Poisson se realiza regresion lineal de Poisson
# para todas las variables
modelo_glm <- glm(D ~ . -D, data = Tarea4, family = poisson)
summary(modelo_glm) 
```

Las variables que presentan significancia predictora con respecto a D respuesta, son: A, P, H1, H2 y H4.
